// data.jsx — mock data for Casilla (asistente fiscal IA)
...
// ---- Casillas extraídas del Modelo 303 (2T 2026) ----
// confidence: alta | media | baja  · ai: rellenado por IA
const FIELD_GROUPS = [
  {
    id: "ident",
...
// ---- Markdown generado por la IA ----
const GENERATED_MD = `# Modelo 303 — Autoliquidación de IVA
...
Object.assign(window, { DOCUMENTS, STATUS_META, FIELD_GROUPS, GENERATED_MD, PIPELINE });
